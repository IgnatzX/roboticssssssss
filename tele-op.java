...
task main()
{
    ...
    double scaleFactor = 40.0 / 127; // Sets max. power and maps range of analog stick to max. power
    double aPosition = ServoValue[servo2]; // Stores the current position of the arm servo
